...
@Composable
fun LibaryCreateScreen( navController: NavController, viewModel: libaryViewModel) {
        ...
        Surface(
            ...
            Scaffold(topBar = {
                GenericAppBar(
                    ...
                    onItemClick = {
                        viewModel.create(
                            currentlibary_candidate.value,
                            currentlibary_namebook.value,
                            currentlibary_bookno.value,
                            currentlibar_imageuri.value
                        )
                ...
                Column(
                    ...
                    if (currentlibar_imageuri.value.isNotEmpty()) {
                        Image(
                    ...
                    TextField(value = currentlibary_candidate.value,
                        ...
                        onValueChange = { value ->
                           ...
                           saveButton.value=currentlibary_candidate.value!="" && currentlibary_namebook.value!=""
                                   && currentlibary_namebook.value!=""
                    ...
                    Spacer(modifier = Modifier.padding(12.dp))
                    TextField(value = currentlibary_bookno.value,modifier=Modifier.fillMaxWidth(),
                        colors = TextFieldDefaults.textFieldColors(
                            cursorColor = Color.Black, focusedLabelColor = Color.Black
                        ),
                        onValueChange = { value ->
